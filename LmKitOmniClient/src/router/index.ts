...
const PAGE_TITLES: Record<string, string> = {
  ...
  Memory: 'Bộ nhớ Agent',
  Agents: 'Thiết kế Agent',
  Schedules: 'Lịch trình tự động',
  Research: 'Nghiên cứu chuyên sâu',
  Projects: 'Dự án',
  ApiKeys: 'Khóa API',
  CustomInstructions: 'Hướng dẫn tùy chỉnh',
  TextTools: 'Phân tích văn bản',
  VisionTools: 'Thị giác & OCR',
  AgentMode: 'Agent tự động hóa',
  Approvals: 'Phê duyệt tác vụ',
  AdminHub: 'Quản trị',
  AdminUsers: 'Quản lý tài khoản',
  AdminMcpServers: 'Máy chủ MCP',
