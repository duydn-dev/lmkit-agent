...
const navCards = [
  ...
  { to: '/admin/databases', icon: 'pi pi-table', accent: 'bg-gradient-to-br from-indigo-500 to-blue-600', title: 'Kết nối Database', description: 'Kết nối cơ sở dữ liệu ngoài để agent truy vấn và lập chỉ mục lược đồ.' },
