...
namespace LmKitOmniApi.Migrations
{
    ...
    [Migration("20260907092545_ChatShareLinkExpiry")]
    partial class ChatShareLinkExpiry
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LmKitOmniApi.Domain.Entities.AgentRun", b =>
                {
                    ...
                    b.Property<DateTime?>("ResumeLeaseUntilUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("ResumeState", "ResumeLeaseUntilUtc");
            ...
            modelBuilder.Entity("LmKitOmniApi.Domain.Entities.CanvasArtifact", b =>
                {
                    ...
                    b.HasIndex("TenantId", "RootId", "Version")
                        .IsUnique();
            ...
            modelBuilder.Entity("LmKitOmniApi.Domain.Entities.LoraAdapterRegistration", b =>
                {
                    ...
                    b.ToTable("lora_adapter_registrations");
                });
