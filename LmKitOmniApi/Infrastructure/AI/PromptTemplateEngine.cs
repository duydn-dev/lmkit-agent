...
public class PromptTemplateEngine
{
    ...
    {
        // Đa tenant: tên tổ chức là BIẾN ({{org_name}}) theo tenant đang đăng nhập —
        // không bao giờ hardcode một đơn vị mặc định, kẻo trợ lý tự xưng sai đơn vị
        // khi phục vụ tenant khác. Tenant không có tên tổ chức → câu chỉ còn tên trợ lý.
        ["default"] = @"Bạn là {{agent_name}}{{#if org_name}} - trợ lý ảo của {{org_name}}{{/if}}.
Nhiệm vụ của bạn là hỗ trợ người dùng tra cứu, tìm kiếm và khai thác thông tin, tài liệu.
